...
from src.model.gemini import ask_gemini
from src.model.gpt.prompts import (
    BATCH_MESSAGES_SYSTEM_PROMPT,
    REFERENCED_MESSAGES_SYSTEM_PROMPT,
)
from src.model.gemini.prompts import (
    BATCH_MESSAGES_SYSTEM_PROMPT as GEMINI_BATCH_MESSAGES_SYSTEM_PROMPT,
    REFERENCED_MESSAGES_SYSTEM_PROMPT as GEMINI_REFERENCED_MESSAGES_SYSTEM_PROMPT,
)
...
class DiscordChatter:
    ...
    async def _gpt_referenced_messages(
        ...
        try:
            ...
            ok, gpt_response = ask_gemini(
                random.choice(self.config.GEMINI.API_KEYS),
                self.config.GEMINI.MODEL,
                user_message,
                GEMINI_REFERENCED_MESSAGES_SYSTEM_PROMPT,
                proxy=self.config.GEMINI.PROXY_FOR_GEMINI,
            )
    ...
    async def _gpt_batch_messages(self, messages_contents: list[str]) -> str:
        try:
            ...
            ok, gpt_response = ask_gemini(
                ...
                self.config.GEMINI.MODEL,
                user_message,
                GEMINI_BATCH_MESSAGES_SYSTEM_PROMPT,
                proxy=self.config.GEMINI.PROXY_FOR_GEMINI,
            )
